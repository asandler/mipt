...
public:
	TMapEdgeIteratorImpl(AdjustMatrixMap &e, const std::string &s) : E(e), from(s) {
...
public:
        TVectorEdgeIteratorImpl(AdjustMatrixVector &e, VertexMap &v, ReVertexMap &r, const std::string &s) : E(e), V(v), R(r), from(s) {
...
public:
        TListEdgeIteratorImpl(MapList &e, const std::string &s) : E(e), from(s) {
                cur = E[from].begin();
        }
        virtual TEdgeIteratorImpl* Clone() const {
...
class TEdgeIterator {
public:
    	TEdgeIterator(TEdgeIteratorImpl* a) : Impl(a) {}
    	TEdgeIterator(const TEdgeIterator &a) : Impl(a.Impl->Clone()) {}
