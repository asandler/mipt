...
void Application::makeSceneImplementation() {
    ...
    _snowTexId = Texture::loadTexture("images/snow.jpg");
    _groundTexId = Texture::loadTexture("images/ground.jpg");
    _alphaMapTexId = Texture::loadTexture("images/alphamap.dds");
...
void Application::drawScene(Camera& camera) {
    ...
    glBindTexture(GL_TEXTURE_2D, _alphaMapTexId);
    glBindSampler(4, _sampler);

    _commonMaterial.setDiffuseTexUnit(1, 0); //текстурный юнит 0
    _commonMaterial.setDiffuseTexUnit(2, 1); //текстурный юнит 1
    _commonMaterial.setDiffuseTexUnit(3, 2); //текстурный юнит 2
    _commonMaterial.setDiffuseTexUnit(4, 3); //текстурный юнит 3
    _commonMaterial.setDiffuseTexUnit(5, 4); //текстурный юнит 4
